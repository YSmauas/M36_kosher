...
אפליקציית ניהול והתאמה מתקדמת למערכת ההפעלה של נגני אנדרואיד כשרים (M36, m36+ ומכשירים מקבילים כמו m393). האפליקציה מאפשרת שליטה מדויקת, מאובטחת ומודולרית על רכיבי המערכת, תוך מעבר קל בין פרופילי כשרות- ניהול יכולות וידאו, התקנת חבילות ושירותי גוגל.
...
הפרויקט ברשיון MIT אפשר להעתיק, לערוך, ולפרסם עם קרדיט למקור.
